...
namespace Calc.View.FluentControl
{
    public static class PointerTracker
    {
        ...
        public static readonly DependencyProperty XProperty = DependencyProperty.RegisterAttached("X", typeof(double), typeof(PointerTracker), new FrameworkPropertyMetadata(double.NaN, FrameworkPropertyMetadataOptions.Inherits));
        ...
        public static readonly DependencyProperty YProperty = DependencyProperty.RegisterAttached("Y", typeof(double), typeof(PointerTracker), new FrameworkPropertyMetadata(double.NaN, FrameworkPropertyMetadataOptions.Inherits));
        ...
        public static readonly DependencyProperty PositionProperty = DependencyProperty.RegisterAttached("Position", typeof(Point), typeof(PointerTracker), new FrameworkPropertyMetadata(new Point(0, 0), FrameworkPropertyMetadataOptions.Inherits));


        private static bool GetIsEnter(DependencyObject obj) => (bool)obj.GetValue(IsEnterProperty);
        ...
        public static readonly DependencyProperty IsEnterProperty = DependencyProperty.RegisterAttached("IsEnter", typeof(bool), typeof(PointerTracker), new FrameworkPropertyMetadata(false, FrameworkPropertyMetadataOptions.Inherits));
        ...
        public static readonly DependencyProperty RootObjectProperty = DependencyProperty.RegisterAttached("RootObject", typeof(UIElement), typeof(PointerTracker), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits));
        ...
        public static readonly DependencyProperty EnabledProperty = DependencyProperty.RegisterAttached("Enabled", typeof(bool), typeof(PointerTracker), new PropertyMetadata(false, OnEnabledChanged));
        ...
        {
            if(sender is UIElement ctrl) SetIsEnter(ctrl, true);
        }
        ...
        {
            if(sender is UIElement ctrl) SetIsEnter(ctrl, false);
        }
    }
    ...
    {
        public Color Color { private get; set; } = Colors.Black;
        public double Opacity { private get; set; } = 1;

        public double Size { private get; set; } = 100;
        ...
        public override object ProvideValue(IServiceProvider serviceProvider)
        {
            ...
            var brush = new RadialGradientBrush(Color, bgColor) { MappingMode = BrushMappingMode.Absolute, RadiusX = Size, RadiusY = Size };

            var opacityBinding = new Binding("Opacity") { Source = target, Path = new PropertyPath(PointerTracker.IsEnterProperty), Converter = new OpacityConverter(), ConverterParameter = Opacity };
